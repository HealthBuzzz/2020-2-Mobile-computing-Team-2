...
public class BlDataGettingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bl_data_getting_activity);
...
//Send the message//
                            ...
                            Wearable.getMessageClient(BlDataGettingActivity.this).sendMessage(node.getId(), path, message.getBytes());
