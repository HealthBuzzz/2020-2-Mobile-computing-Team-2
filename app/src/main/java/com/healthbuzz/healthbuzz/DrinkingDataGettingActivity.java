...
public class DrinkingDataGettingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_drinking_data_getting);
...
//Register to receive local broadcasts, which we'll be creating in the next step//
        ...
        DrinkingDataGettingActivity.Receiver messageReceiver = new DrinkingDataGettingActivity.Receiver();
...
//Upon receiving each message from the wearable, display the following text//
            ...
            textview.setText(message.split(",")[5]);
...
//Sending a message can block the main UI thread, so use a new thread//
        ...
        new DrinkingDataGettingActivity.NewThread("/my_path", message).start();
...
//Send the message//
                            ...
                            Wearable.getMessageClient(DrinkingDataGettingActivity.this).sendMessage(node.getId(), path, message.getBytes());
