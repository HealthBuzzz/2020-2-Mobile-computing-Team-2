...
//Display the following when a new message is received//
            ...
            String onMessageReceived = intent.getStringExtra("message"); //"I just received a message from the handheld " + receivedMessageNumber++;
...
//Send the message///
                    ...
                    Task<Integer> sendMessageTask =
                            Wearable.getMessageClient(com.healthbuzz.healthbuzz.BlActivity.this).sendMessage(node.getId(), path, message.getBytes());
